...
export const LEGAL_PROSE = [
  ...
  '[&_h2]:scroll-mt-24 [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:font-heading [&_h2]:text-xl [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-foreground',
  '[&_h3]:scroll-mt-24 [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:font-heading [&_h3]:text-base [&_h3]:font-bold [&_h3]:tracking-tight [&_h3]:text-foreground',
  '[&_p]:mb-3',
